...
// *;
int create_boat_cb(sqlite3 *db, CreateBoatParams *params,
                   void (*cb)(Boat *, void *), void *ctx);
Boat *create_boat(sql_allocator a, sqlite3 *db, CreateBoatParams *params,
                  int *rc);
// select * from boat where id = :id;
int get_boat_cb(sqlite3 *db, sql_int64 id, void (*cb)(Boat *, void *),
                void *ctx);
...
// insert into competitor (first_name, last_name, email, boat_id) values
// (:first_name, :last_name, :email, :boat_id) returning *;
int create_competitor_cb(sqlite3 *db, CreateCompetitorParams *params,
                         void (*cb)(Competitor *, void *), void *ctx);
Competitor *create_competitor(sql_allocator a, sqlite3 *db,
                              CreateCompetitorParams *params, int *rc);
// insert into competitor (first_name, last_name) values (:first_name,
// :last_name) returning *;
int create_competitor_no_contact_cb(sqlite3 *db,
                                    CreateCompetitorNoContactParams *params,
                                    void (*cb)(Competitor *, void *),
                                    void *ctx);
Competitor *
create_competitor_no_contact(sql_allocator a, sqlite3 *db,
                             CreateCompetitorNoContactParams *params, int *rc);
// select * from competitor where id = :id;
int get_competitor_cb(sqlite3 *db, sql_int64 id,
                      void (*cb)(Competitor *, void *), void *ctx);
...
int list_competitors_cb(sqlite3 *db, void (*cb)(Competitor *, void *),
                        void *ctx);
...
// insert into catch (competitor_id, species, weight_grams, caught_at) values
// (:competitor_id, :species, :weight_grams, :caught_at) returning *;
int create_catch_cb(sqlite3 *db, CreateCatchParams *params,
                    void (*cb)(Catch *, void *), void *ctx);
Catch *create_catch(sql_allocator a, sqlite3 *db, CreateCatchParams *params,
                    int *rc);
// select * from catch where competitor_id = :competitor_id order by caught_at;
int list_catches_by_competitor_cb(sqlite3 *db, sql_int64 competitor_id,
                                  void (*cb)(Catch *, void *), void *ctx);
CatchList list_catches_by_competitor(sql_allocator a, sqlite3 *db,
                                     sql_int64 competitor_id, int *rc);
