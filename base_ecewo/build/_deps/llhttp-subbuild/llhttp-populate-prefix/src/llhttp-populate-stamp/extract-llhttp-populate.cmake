...
#
get_filename_component(filename "/Users/tim/cprogs/cbase/base_ecewo/build/_deps/llhttp-subbuild/llhttp-populate-prefix/src/v9.4.1.tar.gz" ABSOLUTE)
get_filename_component(directory "/Users/tim/cprogs/cbase/base_ecewo/build/_deps/llhttp-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-llhttp-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-llhttp-populate${i}")
